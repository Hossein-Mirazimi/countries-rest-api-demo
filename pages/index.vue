...
import { fetchAllEndpoint, fetchCountriesByRegion, findBestMatch, sortCallback } from '#imports'
...
<template>
  <div class="container pt-5">
    ...
    <InfinitiveScrollWrapper v-else :chunk-count="16" :threshold="1000" :on-end="() => (isFinished = !isFinished)" :items="filterCountries" class="row mt-4 mt-sm-5">
    ...
    <ClientOnly>
      <div v-if="!isFinished && !error && !pending" class="d-flex mb-5 justify-content-center">
        <LoadingCom />
      </div>
    </ClientOnly>
  </div>
